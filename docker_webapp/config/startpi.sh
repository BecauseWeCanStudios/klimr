...
if [ "$PRODUCTION" == "true" ]; then
    ...
    python3 /${DJANGO_ROOT_DIR}/${DJANGO_PROJECT_NAME}/manage.py migrate --fake-initial
    ...
    python3 /${DJANGO_ROOT_DIR}/${DJANGO_PROJECT_NAME}/manage.py collectstatic --noinput -v 3
else
    ...
    python3 /${DJANGO_ROOT_DIR}/${DJANGO_PROJECT_NAME}/manage.py flush --noinput
...
#####
echo "==> Starting uWSGI ..."
cd /${DJANGO_ROOT_DIR}/${DJANGO_PROJECT_NAME}/
